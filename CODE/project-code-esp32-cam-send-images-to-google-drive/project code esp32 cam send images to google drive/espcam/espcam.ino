...
const char* ssid     = "Akshata";   //your network SSID
const char* password = "81831036";   //your network password

String myScript = "/macros/s/AKfycbztGQ7OutQpiJHbcDFJamDU0tyXQvnEEkiSy3vS66LrKtkPIdjW-pgQosv8Nx4ckxDrrw/exec";    //Create your Google Apps Script and replace the "myScript" path.
...
String myFoldername = "&myFoldername=ESP32-images-cam3";
String myFilename = "";
int count = 0;
